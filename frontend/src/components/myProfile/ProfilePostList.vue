<template>
  <div class="container">
    <div v-for="(post, index) in posts" :key="post.id">
      <div v-if="post.author.username === userInfo.username" class="card mb-5"
           style="margin: 0 auto; min-height: 300px; width: 25rem">
        <div>
          <div
              class="p-2 pb-0 mt-0 d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex justify-content-between" style="padding: 0 1rem">
            <div class="d-flex w-25 justify-content-between">
              <button style="border: none; background-color: white" @click="liked(index)" ref="likeBounce">
                <svg xmlns="http://www.w3.org/2000/svg" :fill="likeFillColor[index]" viewBox="0 0 24 24"
                     stroke-width="1.5"
            ...
            <button style="border: none; background-color: white" @click="saved(index)" ref="savedBounce">
              <svg xmlns="http://www.w3.org/2000/svg" :fill="saveFillColor[index]" viewBox="0 0 24 24"
                   stroke-width="1.5"
                   stroke="currentColor" class="w-6 h-6" style="width: 25px">
                <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="card-body">
            ...
            <div id="read-more">
              <div class="card-text">
                ...
                <span v-if="post.description.length > 50" class="read-more-button"
                      @click="toggleReadMore()">more...</span>
              </div>
            </div>
