...
SECRET_KEY = 'django-insecure-kq1mmt!d6+e$jxwh8x$5w0t1qyswc*8!r86c-6xze8_o^&31uz'
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "crud.token_serializers.MyTokenObtainPairSerializer",
